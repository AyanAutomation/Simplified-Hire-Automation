...
public class Side_menu_Handler extends Simplified_hire_login {
	...
	public void Menu_option_selector(String opt_text) throws IOException, InterruptedException {
		...
		System.out.println("📘 Description: Access the Simplified Hire dashboard, open the side menu, fetch all available menu options, search for the required option, and click on it.");
		System.out.println();
		...
		System.out.println("✅ Expected: User should be able to access the Simplified Hire dashboard, fetch all visible side menu options successfully, and click the required side menu option.");
		System.out.println();
